...
;
			esc_html_e( 'Hey, just a polite reminder that if you update WordPress you will also need to update your theme and plugins.', 'jolie' );
			echo '</strong>';
			echo '</p></div>';
		}
...
;
	...
	public static function icons_selector() {
		...
		<div class="vamtam-config-icons-selector hidden">
			<input type="search" placeholder="<?php esc_attr_e( 'Filter icons', 'jolie' ) ?>" class="icons-filter"/>
