...
class VamtamElementorBridge {
	...
	public static function add_sticky_header_bg_color_to_elementor_global_settings() {
		...
		$kit->add_repeater_row( 'system_colors', [
			...
			'title' => __( 'Sticky Header Bg Color', 'jolie' ),
	...
	*/
		...
		if ( $use_el_global_defaults ) {
			...
			for ( $i = 1; $i <= 8; $i++ ) {
				...
				$kit->add_repeater_row( 'system_colors', [
					...
					'title' => sprintf( __( 'Accent %s', 'jolie' ), $i ),
	...
	protected static function add_theme_fonts_to_elementor_global_fonts() {
		...
		if ( $use_el_global_defaults ) {
			...
			// Adding from vamtam_get_option().
			$our_fonts = [
				'primary-font' => __( 'Primary Font', 'jolie' ),
				'h1'           => __( 'H1', 'jolie' ),
				'h2'           => __( 'H2', 'jolie' ),
				'h3'           => __( 'H3', 'jolie' ),
				'h4'           => __( 'H4', 'jolie' ),
			...
			foreach ( $our_fonts as $font_prefix => $font_title ) {
				...
				$kit->add_repeater_row( 'system_colors', [
					...
					'title' => sprintf( __( '%s', 'jolie' ), $font_title ),
	...
	public static function register_locations( $elementor_theme_manager ) {
		...
		$elementor_theme_manager->register_location(
			'page-title-location',
			[
				'label' => esc_html__( 'Page Title', 'jolie' ),
				'multiple' => true,
	...
	public static function get_widget_mods_list() {
		...
		*/
		...
		$widget_mods_list = [
			...
			'animated-headline'                          => [ 'label' => __( 'Animated Headline', 'jolie' ) ],
			'button'                                     => [ 'label' => __( 'Button', 'jolie' ) ],
			'call-to-action'                             => [ 'label' => __( 'Call To Action', 'jolie' ) ],
			'form'                                       => [ 'label' => __( 'Form', 'jolie' ) ],
			'login'                                      => [ 'label' => __( 'Login', 'jolie' ) ],
			'tabs'                                       => [ 'label' => __( 'Tabs', 'jolie' ) ],
			'toggle'                                     => [ 'label' => __( 'Toggle', 'jolie' ) ],
			'heading'                                    => [ 'label' => __( 'Heading', 'jolie' ) ],
			'image'                                      => [ 'label' => __( 'Image', 'jolie' ) ],
			'icon-box'                                   => [ 'label' => __( 'Icon Box', 'jolie' ) ],
			'nav-menu'                                   => [ 'label' => __( 'Nav Menu', 'jolie' ) ],
			'testimonial-carousel'                       => [ 'label' => __( 'Testimonial Carousel', 'jolie' ) ],
			'section'                                    => [ 'label' => __( 'Section', 'jolie' ) ],
			'search-form'                                => [ 'label' => __( 'Search Form', 'jolie' ) ],
			'woocommerce-menu-cart'                      => [ 'label' => __( 'Menu Cart', 'jolie' ) ],
			'wc-loops-common-mods'                       => [ 'label' => __( 'WooCommerce Loops (common)', 'jolie' ) ],
			'wc-categories'                              => [ 'label' => __( 'Product Categories', 'jolie' ) ],
			'woocommerce-products'                       => [ 'label' => __( 'Products', 'jolie' ) ],
			'wc-archive-products'                        => [ 'label' => __( 'Archive Products', 'jolie' ) ],
			'woocommerce-product-related'                => [ 'label' => __( 'Product Related', 'jolie' ) ],
			'woocommerce-product-upsell'                 => [ 'label' => __( 'Upsells', 'jolie' ) ],
			'woocommerce-product-data-tabs'              => [ 'label' => __( 'Product Data Tabs', 'jolie' ) ],
			'woocommerce-product-meta'                   => [ 'label' => __( 'Product Meta', 'jolie' ) ],
			'woocommerce-product-images'                 => [ 'label' => __( 'Product Images', 'jolie' ) ],
			'woocommerce-product-price'                  => [ 'label' => __( 'Product Price', 'jolie' ) ],
			'woocommerce-product-short-description'      => [ 'label' => __( 'Product Short Description', 'jolie' ) ],
			'woocommerce-product-additional-information' => [ 'label' => __( 'Product Additional Information', 'jolie' ) ],
			'woocommerce-product-add-to-cart'            => [ 'label' => __( 'Add To Cart', 'jolie' ) ],
			'woocommerce-product-rating'                 => [ 'label' => __( 'Product Rating', 'jolie' ) ],
			'wc-elements'                                => [ 'label' => __( 'WooCommerce Pages', 'jolie' ) ],
			'woocommerce-my-account'                     => [ 'label' => __( 'WC My Account', 'jolie' ) ],
			'archive-posts'                              => [ 'label' => __( 'Archive Posts', 'jolie' ) ],
			'posts'                                      => [ 'label' => __( 'Posts', 'jolie' ) ],
			'post-comments'                              => [ 'label' => __( 'Post Comments', 'jolie' ) ],
			'post-navigation'                            => [ 'label' => __( 'Post Navigation', 'jolie' ) ],
			// Not a widget, but same logic.
			'vamtam-popup'                               => [ 'label' => __( 'Popup', 'jolie' ) ],
		];
	...
	public static function get_wc_mods_list() {
		...
		$wc_mods_list = [
			...
			'cart-page-theme-mod'     => [
				'label'       => __( 'Cart', 'jolie' ),
				'description' => __( 'Toggles any custom theme styles & funcionality added on the Cart page.', 'jolie' ),
			],
			'checkout-page-theme-mod' => [
				'label' => __( 'Checkout', 'jolie' ),
				'description' => __( 'Toggles any custom theme styles & funcionality added on the Checkout/Order Received page.', 'jolie' ),
			],
			'account-page-theme-mod'  => [
				'label' => __( 'Account', 'jolie' ),
				'description' => __( 'Toggles any custom theme styles & funcionality added on the My Account page.', 'jolie' ),
			],
		];
	...
	*/
	...
	public static function extract_zip( $file, $to ) {
		...
		if ( ! $unzip_result ) {
			$unzip_result = new \WP_Error( 'error', esc_html__( 'Could not unzip or empty archive.', 'jolie' ) );
		}
